...
@Table(name = "symptoms", indexes = {
        @Index(name = "idx_symptoms_user_entry_date", columnList = "user_id,entry_date"),
        @Index(name = "idx_symptoms_user_severity_date", columnList = "user_id,severity,entry_date")
})
